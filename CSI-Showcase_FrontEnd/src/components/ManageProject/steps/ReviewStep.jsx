  ...
  return (
    <div className="space-y-6">
      <Alert
        ...
        description="กรุณาตรวจสอบความถูกต้องของข้อมูลก่อนบันทึก"
        type="info"
        showIcon
        className="mb-4"
      />
      ...
      <div className="bg-gray-50 p-4 rounded-lg">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            <p className="text-sm text-gray-500">การแสดงผล</p>
            <p className="font-medium">
      ...
      <div className="bg-gray-50 p-4 rounded-lg">
        ...
        {(!contributors || contributors.length === 0) ? (
          <p className="text-gray-500">ไม่มีผู้ร่วมโปรเจค</p>
        ) : (
            ...
            {contributors.map((contributor) => (
              ...
              >
                ...
                <div className="flex-1">
                  <div className="font-medium">{contributor.fullName}</div>
                  <div className="text-xs text-gray-500">@{contributor.username}</div>
                </div>
                <Tag color={getContributorRoleColor(contributor.role)}>
