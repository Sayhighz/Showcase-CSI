/**
 * Context สำหรับจัดการการค้นหา
 * ใช้สำหรับจัดการและแชร์ state ที่เกี่ยวข้องกับการค้นหาระหว่าง component ต่างๆ
 */
...
export const SearchProvider = ({ children }) => {
  ...
  // ดึงข้อมูลแท็กยอดนิยมและการค้นหายอดนิยมเมื่อ component mount
  useEffect(() => {
    fetchPopularTags();
...
/**
 * Custom hook สำหรับใช้งาน SearchContext
...
export const useSearchContext = () => {
  ...
  if (!context) {
    throw new Error('useSearchContext ต้องใช้ภายใน SearchProvider');
  }
  
  return context;
};

export default { SearchContext, SearchProvider, useSearchContext };