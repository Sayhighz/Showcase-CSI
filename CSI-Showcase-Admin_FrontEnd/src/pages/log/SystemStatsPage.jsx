...
const SystemStatsPage = () => {
  ...
  const [_selectedDateRange, setSelectedDateRange] = useState(null);
  ...
  const reviewsByDayChartData = useMemo(() => {
  ...
  const dailyStats = useMemo(() => calculateDailyStats(), [systemStats]);
